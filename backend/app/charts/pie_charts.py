...
from .theme import apply_theme, get_chart_colors, BG_COLOR, SURFACE_COLOR, TEXT_COLOR, TEXT_MUTED
...
def _pie_chart(
    ...
    if donut:
        centre_circle = plt.Circle((0, 0), 0.50, fc=SURFACE_COLOR)
        ax.add_patch(centre_circle)
        ax.text(0, 0, ar(f"المجموع\n{total}"), ha='center', va='center',
                fontsize=14, fontweight='bold', color=TEXT_COLOR)

    ax.set_title(ar(title), fontsize=16, fontweight='bold', color=TEXT_COLOR, pad=20)
